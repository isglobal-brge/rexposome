...
`rexposome` is currently in development and not available from CRAN nor Bioconductor. Anyway, the package can be installed by using `devetools` R package and taking the source from Bioinformatic Research Group in Epidemiology's GitHub repository.
...
```{r exwas_plot, warning=FALSE, fig.width=10, fig.height=9}
library(gridExtra)
