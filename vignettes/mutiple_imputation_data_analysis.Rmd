...
## Dummy Imputation with `mcia`

To illustrate how to perform a multiple imputation using `mcia` we start loading both `rexposome` and `mice` and calling the data-set *exposome*:
